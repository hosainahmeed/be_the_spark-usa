...
const ProfilePage: React.FC = () => {
    ...
    const data = [
        { label: 'Business Name', value: profileData.subtitle },
                        ...
                        {!updateProfile && !changePassword && (
                            <div className="rounded-xl px-6 py-4 flex flex-col items-center min-w-[140px]">
                                <div className="text-2xl font-bold text-gray-900 mb-1">
                                    {profileData.rating} <span className="text-base font-normal text-gray-400">/ 5</span>
                                </div>
                                <div className="flex gap-1 mb-2">
                                    {renderStars(profileData.rating)}
                                </div>
                                <div className="text-xs text-gray-500">
                                    Total Ratings: {profileData.totalRatings}
                                </div>
                            </div>
                        )}
                    </div>
