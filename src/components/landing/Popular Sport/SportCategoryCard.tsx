...
function SportCategoryCard({ title, background, icon }: { title: string, background: StaticImageData, icon: StaticImageData }) {
    ...
    return (
        ...
        >
            <div>
                <Image
                    className="w-20 h-20"
                    src={icon.src} alt={title} width={100} height={100} />
            </div>
